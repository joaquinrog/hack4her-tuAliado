...
"Warm & Approachable Advisor" — paleta cálida, tipografía clara y componentes grandes pensados para el arquetipo de menor habilidad digital del reto (botones grandes, íconos sobre texto, jerarquía visual simple). Los tokens de color viven en `assets/palette.png` y se reflejan en la configuración de Tailwind del proyecto.
